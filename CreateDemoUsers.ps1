...
#
# User properties
$ou = "CN=Users,DC=hk,DC=test" # Which OU to create the user in
$initialPassword = "Password123"             # Initial password set for the user
$orgShortName = "WM"                         # This is used to build a user's sAMAccountName
$dnsDomain = "wiseman.local"                      # Domain is used for e-mail address and UPN
$company = "Wiseman Corp."                      # Used for the user object's company attribute
